...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener, UploadCallBacks {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_TAKE_PHOTO || requestCode == REQUEST_PICK_PHOTO) {
                ...
                if (Build.VERSION.SDK_INT > 21) {
                    ...
                    Glide.with(this).load(selectedFileUri).into(imageView);
                    postPath = selectedFileUri.getPath();
    ...
    private void captureImage() {
        if (Build.VERSION.SDK_INT > 21) { //use this if Lollipop_Mr1 (API 22) or above
            ...
            selectedFileUri = getOutputMediaFileUri(MEDIA_TYPE_IMAGE);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // changes
        outState.putParcelable("file_uri", selectedFileUri);
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        // get the file url
        selectedFileUri = savedInstanceState.getParcelable("file_uri");
    }
